...
@objc class AppDelegate: FlutterAppDelegate, FlutterStreamHandler {
    ...
    private var EVENT_CHANNEL_VPN_STAGE : String = "vpnStage"
    private var EVENT_CHANNEL_VPN_STATUS : String = "vpnStatus"
    private var METHOD_CHANNEL_VPN_CONTROL : String = "vpnControl"
